...
import com.growingio.android.sdk.java_websocket.server.WebSocketServer.WebSocketWorker;
...
public class WebSocketImpl implements WebSocket {
	...
	private void send( Collection<Framedata> frames ) {
		if( !isOpen() ) {
			// never throw new WebsocketNotConnectedException(), use callback instead
