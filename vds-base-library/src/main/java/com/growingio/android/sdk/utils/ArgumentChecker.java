...
public class ArgumentChecker {
    ...
    public ArgumentChecker(GConfig config) {
        this.config = config;
    }
    ...
    public boolean isIllegalEventName(String eventName, boolean showLog){
    ...
    public boolean isIllegalValue(String value, boolean showLog){
